...
def loss_function(label, prediction):
    ...
    Arguments:
        label {tf.Tensor} -- The real label
        prediction {tf.Tensor} -- The model prediction
...
def accuracy_function(label, prediction):
    """Applied padding mask to a calculated accuracy

    Arguments:
        label   {tf.Tensor} -- The real label
        prediction {tf.Tensor} -- The model's prediction
