...
class Yolo:
    ...
    def filter_boxes(self, boxes, box_confidences, box_class_probs):
        ...
        Args:
            boxes (list(numpy.ndarray)): Containing the processed boundary
                boxes for each output.
            box_confidences (list(numpy.ndarray)): Containing the processed
                confidences.
            box_class_probs (list(numpy.ndarray)): Containing the processed
                box class probabilities.

        Returns:
            tuple(numpy.ndarray): filtered_boxes, box_classes, box_scores
